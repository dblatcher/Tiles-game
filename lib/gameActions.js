...
const conquerTown = (state, town, faction) => {
    ...
    // to do-  when unitsSupported[] property implemented, remove those supported units from state.units
    ...
    if (town.population === 1) {
        ...
        // to do-  when unitsSupported[] property implemented, empty that array
        town.citizens.pop()
