...
import townNames from './game-entities/townNames.js'
...
const makeGameStateFunction = {
    ...
    test2: () => () => {
        ...
        const mapGrid = MapSquare.makeGridOf(10, 10, { terrain: terrainTypes.plain })
        ...
        mapGrid[3][4].terrain = terrainTypes.swamp
        mapGrid[4][5].terrain = terrainTypes.swamp
        mapGrid[4][6].terrain = terrainTypes.swamp
        mapGrid[5][5].terrain = terrainTypes.swamp
        mapGrid[5][6].terrain = terrainTypes.swamp
        ...
        const factions = [
            ...
            // new ComputerFaction('Verdo', {
            //     color: 'green',
            //     treasury: 100,
            //     townNames: townNames.montenegro,
            //     knownTech: [techDiscoveries.alphabet, techDiscoveries.bronzeWorking, techDiscoveries.masonry],
            // },
            //     {
            //         foo: 'bar'
        ...
        const units = [
            new Unit(unitTypes.dragoon, factions[0], { x: 1, y: 7, vetran: true }),
            new Unit(unitTypes.horseman, factions[1], { x: 9, y: 6, vetran: true }),
