...
const makeGameState = {
    ...
    randomWorld() {
        ...
        const mapWidth = 8, mapHeight = 8

        const mapGrid = MapSquare.makeRandomGrid(mapWidth, mapHeight, .1, 1)
        ...
        factions.forEach(faction => {
            ...
            units.push(new Unit(unitTypes.knight, faction, { x: startingPoint.x, y: startingPoint.y }))
        })
