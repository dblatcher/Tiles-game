...
const makeGameState = {
    ...
    test() {
        ...
        const factions = [
            new Faction('Crimsonia', { color: 'crimson', treasury: 100, knownTech:[techDiscoveries.alphabet, techDiscoveries.pottery, techDiscoveries.writing] }),
            new ComputerFaction('Azula', { color: 'blue' },{foo:'bar'}),
        ]

        const units = [
            new Unit(unitTypes.swordsman, factions[0], { x: 1, y: 3, vetran: true }),
            new Unit(unitTypes.worker, factions[0], { x: 2, y: 0 }),
            new Unit(unitTypes.explorer, factions[0], { x: 4, y: 2 }),
            new Unit(unitTypes.swordsman, factions[1], { x: 3, y: 3 }),
            new Unit(unitTypes.spearman, factions[1], { x: 3, y: 5 }),
            new Unit(unitTypes.horseman, factions[1], { x: 5, y: 5 }),
