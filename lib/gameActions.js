...
const gameActions = {
    ...
    handleUnitClick: clickedUnit => state => {
        ...
        if (state.interfaceMode === 'MOVE') {
            ...
            } else if (clickedUnit.faction === state.activeFaction) { // TO DO - improve behaviour ? - confusing if clicking on a unit will sometimes move and sometimes change unit
            ...
            } else if (state.selectedUnit.type.attack > 0) {
