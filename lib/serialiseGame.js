...
console.log(units)
        ...
        state.units.forEach( unit => {
            console.log(unit.indexNumber, unit.isPassengerOf)
            if (typeof unit.isPassengerOf === 'number') {
                console.log(`unit #${unit.indexNumber}(${unit.faction.name} ${unit.type.displayName}) is a passenger of unit#${unit.isPassengerOf}`)
