...
import { unitTypes } from './game-entities/UnitType.ts'
import { Unit } from './game-entities/Unit.tsx'
import { Faction, ComputerFaction } from './game-entities/Faction.tsx'
import { OnGoingOrder, orderTypesMap } from './game-entities/OngoingOrder.tsx'
...
const makeGameState = {
    ...
    test() {
        ...
        const mapGrid = MapSquare.makeGrid(80, 80, function (x, y) {
            const inWater = (
                !(x - y * 1.5 < 3)
                || y + 2.2 * x > 26
                || (y == 10 && x == 2)
        ...
        const units = [
            new Unit(unitTypes.musketeer, factions[0], { x: 4, y: 1, vetran: true }),
            ...
            new Unit(unitTypes.swordsman, factions[1], { x: 4, y: 4 }),
            ...
            new Unit(unitTypes.horseman, factions[1], { x: 24, y: 2 }),
        ...
        const towns = [
            new Town(factions[0], mapGrid[1][2], { 
                ...
                buildings: [buildingTypes.temple],
                foodStore: 60,
            }),
    ...
    randomWorld() {
        ...
        const mapWidth = 60, mapHeight = 30, treeChance = .35

        const mapGrid = makeMap(mapWidth, mapHeight, treeChance);
        ...
        const factions = [
            ...
            new ComputerFaction('Indigoo', { color: 'purple' },{}),
        ]
